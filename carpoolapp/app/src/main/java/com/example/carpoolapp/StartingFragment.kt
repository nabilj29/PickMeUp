...
class StartingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v = inflater.inflate(R.layout.fragment_starting, container, false)
        val movetologinbtn = v.findViewById<android.widget.Button>(R.id.movetologinbtn)
        val movetosignupbtn = v.findViewById<android.widget.Button>(R.id.movetosignupbtn)
        ...
        movetosignupbtn.setOnClickListener {
            val transaction: FragmentTransaction = requireFragmentManager().beginTransaction()
